  ...
  <v-container>
    ...
    <v-card flat class="border mb-4">
      ...
      <v-table>
        ...
        <tbody>
          <tr v-for="(komputer, index) in getDataKomputerRuangan" :key="komputer.id">
            <td>{{ index + 1 }}</td>
            <td>{{ komputer.id }}</td>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("ruangan", ["getDataRuangan", "getDataKomputerRuangan"]),
  ...
  methods: {
    ...
    ...mapActions("ruangan", ["fetchDataRuangan", "fetchDataKomputerRuangan"]),
  ...
  mounted() {
    this.$store.dispatch("ruangan/fetchDataKomputerRuangan", this.slug);
  },
  created() {
