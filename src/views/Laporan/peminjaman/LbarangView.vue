...
export default {
  ...
  return this.getDatabarang.filter((Lbarang) => {
    return (
      (typeof Lbarang.id === 'string' && Lbarang.id.toLowerCase().includes(searchLowerCase)) ||
      (Lbarang.instansi && Lbarang.instansi.toLowerCase().includes(searchLowerCase)) ||
      (Lbarang.peminjam && Lbarang.peminjam.toLowerCase().includes(searchLowerCase)) ||
      (Lbarang.jenis && Lbarang.jenis.toLowerCase().includes(searchLowerCase)) ||
      (Lbarang.nama_ruangan && Lbarang.nama_ruangan.toLowerCase().includes(searchLowerCase)) ||
      (Lbarang.status_peminjaman && Lbarang.status_peminjaman.toLowerCase().includes(searchLowerCase)) ||
      (Lbarang.tgl_peminjaman && this.formatDate(Lbarang.tgl_peminjaman).includes(searchLowerCase)) ||
      (Lbarang.tgl_kembali && this.formatDate(Lbarang.tgl_kembali).includes(searchLowerCase))
    );
  });
},
  },
